...
class mod_certrt_generator extends testing_module_generator {

    /**
     * Create new certrt module instance
    ...
    public function create_instance($record = null, array $options = null) {
        ...
        $defaults = array();
        $defaults['name'] = get_string('pluginname', 'certrt').' '.$i;
        $defaults['intro'] = 'Test certrt '.$i;
        $defaults['introformat'] = FORMAT_MOODLE;
        $defaults['emailteachers'] = 0;
        $defaults['savecert'] = 0;
        $defaults['reportcert'] = 0;
        $defaults['delivery'] = 0;
        $defaults['certrttype'] = 'A4_non_embedded';
