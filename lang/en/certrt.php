...
//
// You should have received a copy of10 the GNU General Public License
...
$string['certdateformat'] = '%B %d{$a}, %Y';
$string['code'] = 'Code';
$string['column'] = "Column";
$string['columnimage'] = "Column Image";
$string['columnimage_help'] = "Column Image to use exclusive with TRT Certificate type.";
...
$string['customtext'] = 'Custom Text/Signature Name';
...
<br/><br/>*For the TRT certificate type, the custom text is used as a custom text for the body of the certificate.';
$string['date'] = 'On';
...
$string['defaultcustomtext'] = 'A default custom text example';
...
$string['imagetype_help'] = 'Images preferred sizes:
       <br><b> * BORDER:</b> Page size: 1024x831
       <br><b> * COLUMN:</b> 400x2622
       <br><b> * SEAL:</b> 80x80
       <br><b> * SIGNATURE:</b> 600x600
       <br><b> * WATERMARK:</b> 400x400
       <br>Images with diferente sizes may not fit well';
...
$string['validationcode'] = 'Validation Code: {$a}';
$string['verifycertrt'] = 'Verify certificate';
$string['versedefaulthtml'] = "<br/><br/><p> </p><h2 style=\"text-align:center;\">EDITORS</h2> <p style=\"text-align:center;\">...</p>" 
                . "<p> </p><h2 style=\"text-align:center;\">TUTORS</h2><p style=\"text-align:center;\">...</p>"
                . "<p> </p><h2 style=\"text-align:center;\">MODULES</h2><div style=\"text-align:center;\">";
